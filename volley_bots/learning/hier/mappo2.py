...
from volley_bots.learning.utils import valuenorm
from volley_bots.learning.utils.gae import compute_gae
...
class MAPPOPolicy2(object):
    ...
    def train_op(self, tensordict: TensorDict): 
        ...
        next_tensordict = tensordict["next"][:, -1] # only last timestep
        with torch.no_grad():
            value_output = self.value_op(next_tensordict) # compute the value of the last timestep
...
from volley_bots.learning.modules.distributions import (
    CustomDiagGaussian,
...
from volley_bots.learning.modules.rnn import GRU
from volley_bots.learning.common import make_encoder
