...
from volley_bots.utils.math import quaternion_to_euler
...
class Camera:
    ...
    def __init__(self, cfg: Union[PinholeCameraCfg, FisheyeCameraCfg] = None) -> None:
        if cfg is None:
    ...
    def spawn(
        ...
        translations = (
            torch.atleast_2d(torch.as_tensor(translations)).expand(n, 3).tolist()
        )
