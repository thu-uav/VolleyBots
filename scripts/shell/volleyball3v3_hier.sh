CUDA_VISIBLE_DEVICES=0 python ../train_hier.py headless=true \
    ...
    FirstPass_hover_policy_checkpoint_path="hier/checkpoint_firstpass_hover_3.pt" \
    SecPass_goto_policy_checkpoint_path="hier/checkpoint_goto.pt" \
    SecPass_policy_checkpoint_path="hier/checkpoint_secpass_2.pt" \
    SecPass_hover_policy_checkpoint_path="hier/checkpoint_secpass_hover_2.pt" \
    Att_goto_policy_checkpoint_path="hier/checkpoint_goto.pt" \
    Att_policy_checkpoint_path="hier/checkpoint_att_2.pt" \
    Att_hover_policy_checkpoint_path="hier/checkpoint_att_hover_2.pt" \
    seed=0 \
